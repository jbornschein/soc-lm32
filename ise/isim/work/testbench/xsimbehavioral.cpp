...
#include "/home/joerg/Xilinx92i/vhdl/hdp/lin/ieee/std_logic_arith/std_logic_arith.h"
...
#include "/home/joerg/Xilinx92i/vhdl/hdp/lin/ieee/std_logic_unsigned/std_logic_unsigned.h"
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        HSim__s6 * topvh = 0;
        extern HSim__s6 * createWork_testbench_behavioral(const char*);
        topvh = createWork_testbench_behavioral("TestBench");
        addChild(topvh);
        HSim__s5 * topvl = 0;
        extern HSim__s6 * createworkMglbl(const char*);
