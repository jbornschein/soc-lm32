...
#ifndef H_workMlm32__load__store__unit_H
#define H_workMlm32__load__store__unit_H
...
class workMlm32__load__store__unit : public HSim__s5{
public: 
    workMlm32__load__store__unit(const char *instname);
    ~workMlm32__load__store__unit();
    void setDefparam();
    ...
    public: 
        HSim__s3 uv[2];
        cu0(workMlm32__load__store__unit* arch );
        ...
        workMlm32__load__store__unit* Arch ;
